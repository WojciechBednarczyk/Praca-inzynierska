...
Na rysunku ~\ref{fig:architektura} przedstawiono uproszczon¹ architekturê projektowanego systemu. Wyszczególniono na nim bazê danych, backend oraz frontend. Komunikacja pomiêdzy frontendem a backendem odbywa siê poprzez REST API. U¿ytkownicy uzyskuj¹ dostêp do aplikacji poprzez frontend.
...
% TO DO: proszê dopisaæ tu przynajmniej jeden akapit, bo podrozdzia³ jest za krótki. Mo¿e Pan napisaæ o przewidywanym ruchu i wolumenie wymienianych danych, potrzebnej infrastrukturze itp.
