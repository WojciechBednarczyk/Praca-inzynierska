...
Przed przyst¹pieniem do implementacji jakiegokolwiek systemu nale¿y dok³adnie przemyœleæ zasady jego funkcjonowania, sprecyzowaæ wzglêdem niego oczekiwania, przewidzieæ interakcja z u¿ytkownikiem. Z tej te¿ przyczyny w niniejszym rozdziale przedstawiono analizê wymagañ projektowanej aplikacji. Dostarczono w nim opis wymagañ funkcjonalnych  dostêpnych do zidentyfikowanych ról u¿ytkowników oraz sprecyzowano wymaganie niefunkcjonalne. Wymagania zilustrowano ma diagramie przypadków u¿ycia.


\section{Wymagania funkcjonalne}
Dostêp do poszczególnych funkcji aplikacji bêdzie uzale¿niony od roli u¿ytkownika. Zdefiniowano nastêpuj¹ce role: niezalogowany u¿ytkownik, podopieczny oraz trener. Dziêki podzia³owi na role ³atwiej i bezpieczniej bêdzie przebiegaæ jej póŸniejsza implementacja i u¿ytkowanie.\\
% TO DO: DONE

\noindent
\textbf{FR-1}
Niezalogowany u¿ytkownik mo¿e za³o¿yæ konto w systemie podaj¹c wymagane dane takie jak login, has³o oraz podstawowe dane osobowe\\[5pt]
\noindent
\textbf{FR-2}
...
\noindent
\textbf{FR-5}
U¿ytkownik z rol¹ podopiecznego mo¿e wystawiæ opinie trenerowi z którym wspó³pracuje\\[5pt]
\noindent
\textbf{FR-6}
U¿ytkownik z rol¹ podopiecznego mo¿e wys³aæ proœbê do trenera o wspó³pracê\\[5pt]
\noindent
\textbf{FR-7}
Trener mo¿e stworzyæ plan treningowy dla podopiecznego bazuj¹c na tabeli z æwiczeniami\\[5pt]
\noindent
\textbf{FR-8}
U¿ytkownik z rol¹ trenera mo¿e odrzuciæ proœbê o rozpoczêcie wspó³pracy od podopiecznego\\[5pt]
\noindent
\textbf{FR-9}
U¿ytkownik z rol¹ trenera mo¿e zaakceptowaæ proœbê o rozpoczêcie wspó³pracy od podopiecznego\\[5pt]
\noindent
\textbf{FR-10}
U¿ytkownik z rol¹ trenera mo¿e zakoñczyæ wspó³pracê z podopiecznym\\[5pt]
\noindent
\textbf{FR-11}
...
Wymaganie niefunkcjonalne to wymaganie które nie s¹ zwi¹zane z funkcjonalnoœci¹ projektowanej aplikacji. Okreœlaj¹ one techniczne aspekty aplikacji oraz po¿¹dane zachowanie systemu. Wymagania te mog¹ odnosiæ siê do dostêpnoœci, wydajnoœci czy bezpieczeñstwa projektowanej aplikacji.\\
...
\noindent
\textbf{NFR-8}
Aplikacja musi dzia³aæ poprawnie na najpopularniejszych przegl¹darkach typu Firefox, Chrome czy Safari\\
...
Na rysunku ~\ref{fig:architektura} przedstawiono uproszczon¹ architekture projektowanego systemu. Wyszczególniono na nim bazê danych, backend oraz frontend. Komunikacja pomiêdzy frontendem a backendem odbywa siê poprzez REST API. U¿ytkownicy uzyskuj¹ dostêp do aplikacji poprzez frontend.
