...
\begin{enumerate}
  ...
  \item Otwiera siê widok logowanie, na którym znajduje siê formularz
	\item Niezalogowany u¿ytkownik wpisuje w formularzu login oraz has³o
...
\emph{Aktor: } Niezalogowany u¿ytkownik, Podopieczny, Trener\\
\emph{Opis: } Przegl¹danie szczegó³ów danego æwiczenia\\
